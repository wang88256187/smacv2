...
def main():
    ...
    # )
    config_path = "configs/sc2_gen_protoss.yaml"
    with open(config_path) as f:
        args = yaml.load(f)["env_args"]
    args["capability_config"]["n_units"] = 10
    args["capability_config"]["n_enemies"] = 10
    env = StarCraftCapabilityEnvWrapper(**args)
