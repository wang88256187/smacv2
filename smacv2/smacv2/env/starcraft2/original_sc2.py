...
class StarCraft2Env(MultiAgentEnv):
    ...
    def get_state_dict(self):
        ...
        nf_al = self.get_ally_num_attributes()   # prossto example [hp, energy/cooldown, rel_x, rel_y, sheild, type_0, type_1, type_2]
        nf_en = self.get_enemy_num_attributes()  # prossto example [hp, rel_x, rel_y, sheild, type_0, type_1, type_2]
